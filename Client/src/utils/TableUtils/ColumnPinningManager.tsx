...
import { WriteSelectors } from "../ComponentToolbox";
...
export class ColumnPinningManager<T extends string> {
	...
	types = {
		...
		pinningState: [] as { key: T; pin: ColumnPinningType }[],
	};
	 ...
	 */
	createPinningState = (pinnedColumns: { key: T; pin: ColumnPinningType }[] = []) => pinnedColumns;
